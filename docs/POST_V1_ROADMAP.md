...
| # | Item | Owner | Status |
|---|------|-------|--------|
| 3.1 | **The demand side** — the v2 business question: who posts paid jobs? Ingested public-good jobs bootstrap supply; revenue needs external job posters. Candidate wedges: paid data-audit jobs, verifier-as-a-service for other agent platforms, bounty escrow for OSS maintainers | Pascal (strategy) | open |
