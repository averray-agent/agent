...
Unavailable base checks: 16.
Structurally undecidable: 0.
Implementation artifacts: 16.
...
- averray-agent/agent-harness#36: repository_check_unavailable (contract) — the derived assumption that the repository check is runnable and green could not be established
...
- averray-agent/agent-harness#35: repository_check_unavailable (contract) — the derived assumption that the repository check is runnable and green could not be established
  - Attribution judgement: accurate — Rule 5 cannot prove that make gate is defined by one immutable file because Make can select or include multiple definitions. Refusing before execution is an accurate contract-attributable hold.
- averray-agent/agent-harness#32: repository_check_unavailable (contract) — the derived assumption that the repository check is runnable and green could not be established
  - Attribution judgement: accurate — Rule 5 cannot prove that make gate is defined by one immutable file because Make can select or include multiple definitions. Refusing before execution is an accurate contract-attributable hold.
- averray-agent/agent-harness#31: repository_check_unavailable (contract) — the derived assumption that the repository check is runnable and green could not be established
  - Attribution judgement: accurate — Rule 5 cannot prove that make gate is defined by one immutable file because Make can select or include multiple definitions. Refusing before execution is an accurate contract-attributable hold.
- averray-agent/agent-harness#30: repository_check_unavailable (contract) — the derived assumption that the repository check is runnable and green could not be established
...
- averray-agent/agent-harness#29: repository_check_unavailable (contract) — the derived assumption that the repository check is runnable and green could not be established
  - Attribution judgement: accurate — Rule 5 cannot prove that make gate is defined by one immutable file because Make can select or include multiple definitions. The documentation diff remains a clean contract-attributable hold.

Attribution accuracy: 18/18 reviewed (100%).
