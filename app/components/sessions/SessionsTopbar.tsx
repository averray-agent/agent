  ...
  return (
    <header className="flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={onExportAuditBundle}
          disabled={exportDisabled}
          title={exportDisabled ? "A live session feed is required before exporting an audit bundle." : "Download a self-verifying JSON bundle of the current session view."}
