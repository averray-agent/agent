...
verify_site_served() {
  ...
  local entry
  for entry in "index.html /" "console-stream.js /console-stream.js" "transparency/index.html /transparency/" "transparency-reader.js /transparency-reader.js" "verify/index.html /verify/" "proof-to-pay/index.html /proof-to-pay/"; do
    local file="${entry%% *}"
