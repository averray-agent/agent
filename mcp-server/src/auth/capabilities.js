...
export const ROUTE_CAPABILITY_RULES = [
  ...
  { method: "GET", path: "/account/idle-allocation", capabilities: ["account:read"] },
  { method: "POST", path: "/account/idle-allocation/quote", capabilities: ["account:allocate"] },
  { method: "POST", path: "/account/idle-allocation/consent", capabilities: ["account:allocate"] },
  { method: "POST", path: "/account/idle-allocation/revoke", capabilities: ["account:allocate"] },
  ...
  { method: "GET", path: "/transparency", capabilities: ["ops:view"] },
  ...
  { method: "GET", path: "/admin/deposit-pool/subsidies", capabilities: ["ops:view"] },
  { method: "POST", path: "/admin/deposit-pool/subsidies", capabilities: ["admin:yield-subsidy:attest"] },
  ...
  { method: "GET", path: "/admin/l3-posting/refusals", capabilities: ["ops:view"] },
  { method: "POST", path: "/admin/l3-posting/requests", capabilities: ["credit:originate"] },
  { method: "POST", path: "/admin/l3-posting/requests/:id/advance", capabilities: ["credit:originate"] },
  { method: "POST", path: "/admin/l3-posting/requests/:id/reconcile", capabilities: ["credit:originate"] },
  { method: "POST", path: "/admin/l3-posting/sweep", capabilities: ["credit:originate"] },
...
const UI_CONTROLS = {
  ...
  "capital.transparency.view": ["ops:view"],
